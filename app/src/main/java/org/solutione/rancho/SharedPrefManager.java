...
public class SharedPrefManager {
    ...
    //the constants
    private static final String SHARED_PREF_NAME = "rancho";
    private static final String KEY_USERNAME = "keyusername";
    private static final String KEY_EMAIL = "keyemail";
    private static final String KEY_PASS= "keypass";
    private static final String KEY_ID = "keyid";
    private static final String KEY_APE = "keyape";
    ...
    public void userLogin(User user) {
        ...
        editor.putString(KEY_APE, user.getApellidos());
    ...
    public User getUser() {
        ...
        return new User(
                ...
                sharedPreferences.getString(KEY_APE, null),
